...
function esconderCampos(id_campo1, id_campo2, id_campo3, id_campo4) {
...
function esconderCampo(id_campo1, id_campo2, id_campo3, id_campo4, id_select) {
    ...
    if (x == 'CPF/CNPJ') {
        ...
        document.getElementById(id_campo2).style.display = "none";
        document.getElementById(id_campo3).style.display = "none";
        document.getElementById(id_campo4).style.display = "block";
    } else {
        document.getElementById(id_campo1).style.display = "none";
        document.getElementById(id_campo3).style.display = "none";
        document.getElementById(id_campo4).style.display = "none";
...
$(window).on('load', function() {
        ...
        $('conteudo').delay(10).css({ 'overflow': 'visible' });
    })
    //]]>