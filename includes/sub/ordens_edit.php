...
<div class="row mx-auto">
    <div class="col">
        <div class="card shadow p-3" style="max-width: 1000px">
                        ...
                        <div class="modal-dialog" role="document" style="width: 380px; transition: bottom .75s ease-in-out">
                            <div class="modal-content rounded-6 shadow" style="border-radius: .75rem;">
                                ...
                                <div class="modal-footer flex-column border-top-0">
                                    <a type="button" class="btn btn-lg btn-danger w-100 mx-0 mb-2" href="./scripts/orden_del.php?id=<?php echo $id_os ?>&&nome=<?php echo $u_nome; ?>">Sim</a>
            ...
            <form class="needs-validation" action="./scripts/orden_edit.php" method="post">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="dencerramento" value="<?php echo $os_update ?>">
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="tipo" placeholder="" value="<?php echo $os_tipo ?>">
                    </div>
                    <hr class="mb-0">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="zip" placeholder="" value="<?php echo $os_cep ?>">
                    </div>
                    <div class="col-6">
                        <label for="address" class="form-label">Rua:</label>
                        <input type="text" class="form-control" id="address" placeholder="Rua/Av/Rod..." value="<?php echo $os_rua ?>">
                    </div>
                    <div class="col-3">
                        <label for="address" class="form-label">Bairro:</label>
                        <input type="text" class="form-control" id="address" placeholder="Rua/Av/Rod..." value="<?php echo $os_bairro ?>">
                    </div>

                    <div class="col-5">
                        <label for="address" class="form-label">Complemento:</label>
                        <input type="text" class="form-control" id="address" placeholder="Apto, bloco, quadra..." value="<?php echo $os_comp ?>">
                    </div>
                    <div class="col-md-5">
                        <label for="country" class="form-label">Cidade:</label>
                        <input type="text" class="form-control" id="address" placeholder="Cidade" value="<?php echo $os_cidade ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="state" class="form-label">Estado:</label>
                        <input type="text" class="form-control" id="address" placeholder="UF" value="<?php echo $os_uf ?>">
                    </div>
                </div>
                ...
                <div class="row gy-3">
                    <div class="col-md-12 my-3">
                        <textarea class="form-control mt-3" id="exampleFormControlTextarea1" rows="3"><?php echo $os_info ?></textarea>
                    </div>
                </div>
                <hr class="">
