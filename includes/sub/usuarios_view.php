...
<div class="row mx-auto">
    <div class="col">
        <div class="card shadow p-3" style="max-width: 1000px; width: 100%">
            <div class="row">
                <div class="col">
                    <label class="" style="font-weight:bold; font-family: 'Poppins', sans-serif;"><i
                            class="bi bi-info-lg text-primary rounded"
                            style="border-style: solid;border-width: thin;padding:2px 10px;margin-right: 10px; font-size:130%;"></i>Informações
                        Gerais</label>
                </div>
                <!--EDITAR -->
                <div class="col-md-auto">
                    <a type="button" href="?pagina=usuarios_edit&&id=<?php echo $id ?>"
                ...
                <form class="needs-validation" action="./scripts/usuario_add.php" method="post">
                    <div class="" style="width: 100%; margin-left:auto; margin-right:auto">
                        <div class="row g-3">
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control " id="status" name="status"
                                    value="<?php echo $id_usuario ?>" readonly>
                            </div>
                            <div class="col-md-2">
                                <label for="status" class="form-label">Status:</label>
                                <input type="text" class="form-control " id="status" name="status" maxlength="10"
                                    value="<?php if ($u_status == 1) : echo "Ativo";
                                                                                                                            else : echo "Inativo";
                                                                                                                            endif; ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="cc-name" class="form-label">Cadastro:</label>
                                <input type="text" class="form-control" id="cadastro" name="cadastro" placeholder=""
                                    value="<?php echo date('d/m/Y H:i:s', strtotime($u_cadastro)); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="cc-name" class="form-label">Atualização:</label>
                                <input type="text" class="form-control" id="update" name="update" placeholder=""
                                    value="<?php echo date('d/m/Y H:i:s', strtotime($u_update)); ?>" readonly>
                            </div>
                            <div class="row g-3">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control " id="cpfcnpj" name="cpf"
                                                maxlength="14" value="<?php echo $u_cpf ?>" readonly>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" placeholder=""
                                            maxlength="60" value="<?php echo $u_nome ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                        ...
                        <p class="" style="font-weight:bold; font-family: 'Poppins', sans-serif;"><i
                                class="bi bi-telephone text-primary rounded"
                                style="border-style: solid;border-width: thin;padding:2px 10px;margin-right: 10px; font-size:130%;"></i>Contato...
                        </p>
                        <div class="row gy-3">
                            <div class="col-md-6">
                        ...
                        <p class="" style="font-weight:bold; font-family: 'Poppins', sans-serif;"><i
                                class="bi bi-person-check text-primary rounded"
                                style="border-style: solid;border-width: thin;padding:2px 10px;margin-right: 10px; font-size:130%;"></i>Credenciais
                            de acesso...</p>
                        ...
                        <div class="row gy-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="usuario" name="usuario"
                                    placeholder="Usuário de acesso..." value="<?php echo $u_user ?>" readonly>
                            </div>
                        </div>
                        <hr class="my-4">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="info" name="info" rows="3"
                                    readonly><?php echo $u_info ?></textarea>
                            </div>
                        </div>
                        <hr class="my-4">
